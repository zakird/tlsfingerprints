...
class Silk3Accelerated(BrowserVersion):

    CIPHERS = [49172,49162,57,56,53,49170,49160,22,19,10,49199,49195,
            49171,49161,162,158,51,50,156,47,49169,49159,5,4,255]

    EXTENSIONS = [0,11,10,35,13,13172]
    DEFAULT_VERSION = BrowserVersion.VERSION_TLS_1_2
    POINT_COMPRESSION_METHODS=[0,]
    CURVES = [23,24,25]
...
class SilkAccelerated(Browser):

    def __init__(self, *args, **kwargs):
        Browser.__init__(self, *args, **kwargs)
        self.silk3 = Silk3Accelerated()
